...
for k=1:max_iter
    ...
    fill(obs2_x + [-obs2_side_length/2 obs2_side_length/2 obs2_side_length/2 -obs2_side_length/2 -obs2_side_length/2], obs2_y + [-obs2_side_length/2 -obs2_side_length/2 obs2_side_length/2 obs2_side_length/2 -obs2_side_length/2], 'r', 'FaceAlpha', 0.3);
    ...
    for i=1:swarm_size
        ...
        for j=[1:(i-1),(i+1):swarm_size]
            ...
            if lineCrossesSquare([swarm(i, 1), swarm(i, 2)], [swarm(j, 1), swarm(j, 2)], [obs_x, obs_y], obs_side_length) || lineCrossesSquare([swarm(i, 1), swarm(i, 2)], [swarm(j, 1), swarm(j, 2)], [obs2_x, obs2_y], obs2_side_length)
